        ...
        public void DisplayCursor(int numOfHands, Queue<PXCMPoint3DF32>[] cursorPoints, Queue<PXCMPoint3DF32>[] adaptivePoints, int[] cursorClick, PXCMCursorData.BodySideType[] handSideType)
        {
            ...
            if (false/*CursorMode.Checked*/)
            {
                ...
                for (int i = 0; i < numOfHands; ++i)
                {
                    ...
                    if (0 < cursorClick[i] && false)//(Cursor.Checked || Adaptive.Checked))
                    {
                        ...
                        int x = 0, y = 0;
                        if (false)//Cursor.Checked && cursorPoints[i].Count() > 0)
                        {
                        ...
                        else if (false)//Adaptive.Checked && adaptivePoints[i].Count() > 0)
                        {
